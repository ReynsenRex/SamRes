    ...
    public function run()
    {
        ...
        Restaurant::insert([
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/burudy.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/rmpadang.jpg',
            ],[
                ...
                'price' => '$$',
                'location' => 'Jl. Anjasmoro No.45, Sawahan, Kec. Sawahan, Surabaya',
                'image' => 'http://127.0.0.1:8000/images/restaurants/warungbebek.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/gyukaku.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/yoshinoya.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/housaku.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/gojumong.jpg',
            ],
            [
                ...
                'price' => '$$$$',
                'location' => 'Jl. Anjasmoro No.45, Sawahan, Kec. Sawahan, Surabaya,',
                'image' => 'http://127.0.0.1:8000/images/restaurants/songa.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/tteobokki.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/mcd.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/kfc.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/hokben.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/sumatra.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/tutto.jpg',
            ],[
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/nanny.jpg',
            ],
            [
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/pavillion.jpg',
            ],[
                ...
                'price' => '$$$',
                'location' => 'Jl. Anjasmoro No.45, Sawahan, Kec. Sawahan, Surabaya,',
                'image' => 'http://127.0.0.1:8000/images/restaurants/boncafe.jpg',
            ],[
                'name' => 'United Steaks',
                'category_id' => 6, // Category ID for Western
                'rating' => 4.0,
                ...
                'image' => 'http://127.0.0.1:8000/images/restaurants/united.jpg',
            ],
        ]);
    }
}
