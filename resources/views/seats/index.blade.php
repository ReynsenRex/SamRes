...
<script>
    $(document).ready(function() {
        ...
        function fetchSeats() {
            $.ajax({
                url: `/seats/${restaurantId}`, // Get seats from the backend
                method: "GET",
                success: function(data) {
                    renderSeats(data); // Pass the seat data to the render function
                },
                error: function() {
        ...
        $("#confirm-seats").click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    selectedSeats = [];
                    renderSeats(response.allSeats); // Re-render the seat grid with the updated data
                },
                error: function() {
